import { IdeaSchema, OpeningSchema, ContinueSchema } from "./schemas.js";
...
const asOneLine = (obj) => JSON.stringify(obj);

export const ideaUser = (brief) => `
...
export const openingUser = (brief, ctx) => `
...
export const continueUser = (playerInput, tail) => `
